...
df=pd.read_csv( read_path+'Friday-WorkingHours-Afternoon-PortScan.csv' , low_memory = False , encoding = "cp1258" );
...
df.replace({' Label': 'PortScan'},13,inplace=True)
...
export_csv = df.to_csv (write_path+'cleadned_portScan.csv', index = None, columns=write_columns,header=True, mode = 'w', encoding='cp1258')
