...
df=pd.read_csv( read_path+'Friday-WorkingHours-Afternoon-DDos.csv' , low_memory = False , encoding = "cp1258" );
...
df.replace({' Label': 'DDoS'},5,inplace=True)
...
export_csv = df.to_csv (write_path+'cleadned_DDoS.csv', index = None, columns=write_columns,header=True, mode = 'w', encoding='cp1258')
