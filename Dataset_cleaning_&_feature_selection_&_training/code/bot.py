...
df=pd.read_csv( read_path+'Friday-WorkingHours-Morning.csv' , low_memory = False , encoding = "cp1258" );
...
df.replace({' Label': 'Bot'},4,inplace=True)
...
export_csv = df.to_csv (write_path+'cleadned_bot.csv', index = None, columns=write_columns,header=True, mode = 'w', encoding='cp1258')
