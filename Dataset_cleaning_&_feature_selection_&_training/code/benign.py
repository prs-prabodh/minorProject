...
df=pd.read_csv( read_path+'Monday-WorkingHours.csv' , low_memory = False , encoding = "cp1258" );
...
export_csv = df.to_csv (write_path+'cleadned_benign.csv', index = None, columns=write_columns,header=True, mode = 'w', encoding='cp1258')
